			...
			<div className="row">
						...
						<div className="card-body p-4" >
								...
								<div className="row">
									<div className="col-md-8">
										...
										<ul className="list-inline text-muted mb-0">
											<li className="list-inline-item text-warning review-rating"> </li>
										</ul>
									</div>
							...
							<div className="mt-4">
								<div className="row g-2">
									...
									<div className="col-lg-3">
										<div className="border p-3">
											<p className="text-muted fs-13 mb-0"> Graduation Year</p>
							...
							<div className="mt-4">
								...
								<div className="job-detail-desc mt-2">
									<p className="text-muted">As a Product Designer, you will work within a Product Delivery Team fused with UX, engineering, product and data talent.
							...
							<div className="mt-4">
								...
								<div className="job-detail-desc mt-2">
									<ul className="job-detail-list list-unstyled mb-0 text-muted">
										<p> B.C.A / M.C.A under National University course complete.
										3 or more years of professional design experience.
										have already graduated or are currently in any year of study.
										Advanced degree or equivalent experience in graphic and web design</p>
									</ul>
								</div>
							</div>
							<div className="mt-4">
				...
				<div className="col-lg-4 mt-4 mt-lg-0">
					...
					<div className="side-bar ms-lg-4">
						<div className="card job-overview" style={{ zIndex: "-1" }}>
							<div className="card-body p-4">
								<h6 className="fs-17">Job Overview</h6>
								<ul className="list-unstyled mt-4 mb-0">
									<li>
										<div className="d-flex mt-4"> <i className="uil uil-user icon bg-soft-primary"></i>
											<div className="ms-3">
									...
									<li>
										<div className="d-flex mt-4"> <i className="uil uil-star-half-alt icon bg-soft-primary"></i>
											<div className="ms-3">
									...
									<li>
										<div className="d-flex mt-4"> <i className="uil uil-location-point icon bg-soft-primary"></i>
											<div className="ms-3">
									...
									<li>
										<div className="d-flex mt-4"> <i className="uil uil-usd-circle icon bg-soft-primary"></i>
											<div className="ms-3">
									...
									<li>
										<div className="d-flex mt-4"> <i className="uil uil-graduation-cap icon bg-soft-primary"></i>
											<div className="ms-3">
									...
									<li>
										<div className="d-flex mt-4"> <i className="uil uil-history icon bg-soft-primary"></i>
											<div className="ms-3">
												<h6 className="fs-14 mb-2">Company Selection Date</h6>
						...
						<div className="card company-profile mt-4"  style={{ zIndex: "-1" }}>
							<div className="card-body p-4">
								
								<div className="mt-4"> <a href="www.google.com" className="btn btn-primary btn-hover w-100 rounded"><i className="mdi mdi-eye"></i> Publish</a> </div>
							</div>
						</div>
					</div>
